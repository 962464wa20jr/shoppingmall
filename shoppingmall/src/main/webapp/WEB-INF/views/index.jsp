	...
	<div class="main tab mt15">
		...
		<div class="slide">
			<ul id="bigSlideUl" class="slide-ul clearfix">
				...
				<img class="img_class" id="pic1" width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img2.jpg" alt="正品Dior/迪奥口红" onclick="myFunction(3);" />
				<span class="pic-txt">正品Dior/迪奥口红</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img class="img_class" id="pic2" width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img3.jpg" alt="新款四核i3本" onclick="myFunction(4);"/>
				<span class="pic-txt">新款四核i3本</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img id=3 width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img4.jpg" alt="Adidas EQT" onclick="myFunction(5);"/>
				<span class="pic-txt">Adidas EQT</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img5.jpg" alt="杜蕾斯避孕套" onclick="myFunction(6);"/>
				<span class="pic-txt">杜蕾斯避孕套</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img12.jpg" alt="sk-iisk2skii" onclick="myFunction(7);" />
				<span class="pic-txt">sk-iisk2skii</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img13.jpg" alt="飞科电动剃须刀" onclick="myFunction(8);"/>
				<span class="pic-txt">飞科电动剃须刀</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img14.jpg" alt="小型手机照片打印机" onclick="myFunction(9);" />
				<span class="pic-txt">小型手机照片打印机</span> </a></li>
				<li>
				<a  class="picimglink" href="javascript:;">
				<img width="230" height="200" src="${pageContext.request.contextPath}/res/static/img/s_img15.jpg" alt="【三只松鼠_巨型零食大礼包】" onclick="myFunction(10);" />
      ...
      <div class="tlinks">Collect from <a href="http://www.cssmoban.com/" >网页模板</a></div>
       <div class="hot-con1 w1200 layui-clear">
          <div class="item">
            <h4>热销推荐</h4>
            <div class="big-img">
              <a href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot1(2).jpg" onclick="myFunction(11);"></a>
            </div>
            <div class="small-img">
              <a href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot3.jpg" alt="" onclick="myFunction(12);"></a>
            </div>
          </div>
          <div class="item">
            <div class="top-img">
              <a href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot5.jpg" onclick="myFunction(13);"></a>
            </div>
            <div class="bottom-img">
              <a href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot4.jpg" onclick="myFunction(14);"></a>
              <a class="baby-cream" href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot6(2).jpg" onclick="myFunction(15);"></a>
            </div>
          </div>
          <div class="item item1 margin0 padding0">
            <a href="javascript:;"><img src="${pageContext.request.contextPath}/res/static/img/hot2.jpg" onclick="myFunction(16);"></a>
            <a href="javascript:;"><img class="btm-img" src="${pageContext.request.contextPath}/res/static/img/hot7(2).jpg" onclick="myFunction(17);"></a>
          </div>
      </div>
    </div>
